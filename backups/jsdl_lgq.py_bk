...
def model(x,is_train):
    ...
    with tf.variable_scope("conv5") as scope:
        ...
        pool5 = train.avg_pool(conv5,16,1,'VALID',5)
        #        pool5 = train.avg_pool(conv5,32,1,'VALID',5) # 512 x 512
...
def process():
    ...
    with tf.Session(config=config) as sess:
        ...
        for i in range(1,NUM_ITER+1):
            ...
            if i%(NUM_SHOWTEST)==0:
                saver.save(sess,'/home/lgq/Workspace/xu_model/saver/jsdl_m_lgq_'+str(i)+'.ckpt')
