...
c = Config()
c['path1'] = '/data/lgq/BOSS_base/512x512/cover/train'
c['path2'] = '/data/lgq/BOSS_base/512x512/cover/test'
c['path3'] = '/data/lgq/BOSS_base/512x512/suniward_0.4/train'
c['path4'] = '/data/lgq/BOSS_base/512x512/suniward_0.4/test'
c['numdata'] = 5000
...
def process():
    ...
    with tf.Session(config=config) as sess:
        ...
        for i in range(1,NUM_ITER+1):
            ...
            if i%(NUM_SHOWTEST)==0:
                saver.save(sess,'/home/lgq/Workspace/xu_model/saver/xu_m_lgq_'+str(i)+'.ckpt')
